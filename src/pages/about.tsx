...
const values = [
  {
    ...
    desc: "Hacer accesible el cultivo de alimentos frescos y sostenibles en cualquier hogar, uniendo naturaleza y tecnología.",
  },
  {
    icon: Eye,
    title: "Nuestra visión",
    desc: "Un mundo donde cada hogar pueda producir parte de su alimento de forma limpia, eficiente y consciente.",
  },
  {
    icon: Heart,
    ...
    <>
      <section className="relative overflow-hidden border-b border-border/60">
        ...
        <div className="mx-auto max-w-3xl px-4 py-20 text-center sm:px-6 lg:py-28 lg:px-8">
          <span className="text-sm font-semibold text-primary">Sobre Raizal</span>
          ...
          <p className="mt-6 text-pretty text-lg leading-relaxed text-muted-foreground">
            ...
            están en conflicto, pueden crecer juntas. Diseñamos torres de cultivo
            vertical inteligentes para que producir tu propio alimento sea natural,
            sostenible y profundamente humano. <br /> <br />
            No somos solo una granja urbana. Somos una red descentralizada de producción de alimentos que prioriza la dignidad humana y la transparencia absoluta de los datos. <br /> <br />
        ...
        <div className="grid gap-5 lg:grid-cols-3">
          {values.map((v) => (
            ...
            >
              ...
              <h2 className="mt-5 text-lg font-semibold text-foreground">{v.title}</h2>
        ...
        <div className="mt-16 grid items-center gap-12 rounded-3xl border border-border/60 bg-card/20 p-8 backdrop-blur-sm lg:grid-cols-2 lg:gap-16 lg:p-12">
          <div>
            ...
            <p className="mt-4 text-pretty leading-relaxed text-muted-foreground">
              Cada torre Raizal es el resultado de combinar agronomía, ingeniería
              de software y diseño sostenible. Medimos lo que importa, automatizamos
              lo repetitivo y dejamos que tú disfrutes de lo esencial: ver crecer
              tu propio alimento.
            </p>
            <dl className="mt-8 grid grid-cols-3 gap-6">
              {[
                { value: "12k+", label: "Huertos activos" },
                { value: "95%", label: "Menos agua" },
                { value: "40+", label: "Cultivos posibles" },
              ].map((stat) => (
                <div key={stat.label}>
